...
export function EnvToggle() {
  ...
  return (
    <div
      ...
      className={cn(
        'relative inline-flex shrink-0 items-center rounded-full bg-cream-soft p-0.5 sm:p-1',
        'select-none ring-1 ring-line/70',
    ...
    >
      <span
        aria-hidden
        className={cn(
          'pointer-events-none absolute top-0.5 bottom-0.5 rounded-full bg-surface sm:top-1 sm:bottom-1',
      ...
      {OPTIONS.map((opt) => {
        ...
        return (
          <button
            ...
            className={cn(
              'relative z-10 min-h-8 min-w-[2.65rem] rounded-full px-2 py-0.5',
              'text-[9px] font-semibold uppercase tracking-[0.06em]',
              'sm:min-h-9 sm:min-w-[3.5rem] sm:px-3 sm:py-1.5 sm:text-[11px] sm:tracking-[0.08em]',
